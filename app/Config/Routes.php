...
$routes->post('posts/download', 'Home::spreadsheet_format_download');
$routes->get('products/delete/(:num)', 'PostController::delete/$1');
$routes->get('/', 'FormController::index');
$routes->post('posts/import-csv', 'FormController::importCsvToDb');
